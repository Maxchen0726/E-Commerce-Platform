    ...
    <el-row>
      <el-col :span="3">
        <div style="font-size: 20px; font-weight: bold; text-align: center">
          <a href="/"><i class="iconfont icon-r-home" style="font-size: 24px;"></i> Online mall</a>
        </div>
      </el-col>
      <el-col :span="17">
        <el-menu
        ...
        <el-dropdown style="cursor: pointer; float: right; margin-right: 60px">
          ...
          <el-dropdown-menu slot="dropdown" style="text-align: center">
            ...
            <el-dropdown-item v-show="loginStatus">
              <div @click="$router.push('/person')">personal details</div>
            </el-dropdown-item>
            <el-dropdown-item v-show="loginStatus">
...
export default {
  ...
  methods: {
    logout() {
      ...
      this.$router.go(0);
      this.$message.success("successfully_logged_out");
    },
  },
};
</script>
